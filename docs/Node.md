...
* 1 Class: [FabBox](#node--fabbox):
  ...
  * 1.3 [intersect()](#node----intersect): Compute Line Segment intersection with a FabBox.
* 2 Class: [FabNode](#node--fabnode):
  ...
  * 2.14 [set_app_object_only()](#node----set-app-object-only): Set FabNode AppObject only.
  * 2.15 [set_gui_object_only()](#node----set-gui-object-only): Set FabNode GuiObject only.
  * 2.16 [set_object()](#node----set-object): Set both AppObject and GuiObject in FabNode.
  * 2.17 [set_tracing()](#node----set-tracing): Set the FabNode indentation tracing level.
  * 2.18 [probe()](#node----probe): Perform a probe operation.
...
FabBox.enclose(self, bounds: Sequence[Union[Base.Vector, ForwardRef('BoundBox'), ForwardRef('FabBox')]]) -> None:
...
FabBox.intersect(self, segment_start: Base.Vector, segment_end: Base.Vector, tracing: str = '') -> Tuple[bool, float, float]:
...
### <a name="node----probe"></a>2.18 `FabNode.`probe():
