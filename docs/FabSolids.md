...
FabSolid.mount(self, name: str, plane: FabGeometries.FabPlane, depth: float, orient_start: cadquery.occ_impl.geom.Vector, orient_end: cadquery.occ_impl.geom.Vector, cnc_origin: Union[cadquery.occ_impl.geom.Vector, NoneType] = None, cnc_orient: Union[cadquery.occ_impl.geom.Vector, NoneType] = None, tracing: str = '') -> FabSolids.FabMount:
